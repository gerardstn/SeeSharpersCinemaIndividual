...
(function ($) {
    function Movieseat(_paramObject) {
        ...
        var getMainLayoutFunc = function (_obj) {
            ...
            var actionPanel = pluginOptions.showActionButtons ? "<div class='seat-proccess-panel'> <button  type='button' class='btn btn-secondary layout-action-btn layout-btn-cancel  " + pluginOptions.classes.cancelBtn + "'> Cancel </button> <button type='button' class='btn btn-primary layout-action-btn layout-btn-done " + pluginOptions.classes.doneBtn + "'> To payment </button> </div>" : "";
