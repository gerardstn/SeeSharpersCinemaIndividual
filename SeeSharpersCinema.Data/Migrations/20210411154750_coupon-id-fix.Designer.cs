...
namespace SeeSharpersCinema.Data.Migrations
{
    ...
    [Migration("20210411154750_coupon-id-fix")]
    partial class couponidfix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeeSharpersCinema.Models.Order.Coupon", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            Code = "qdzffpKWzeUQWnxyhhtYdZbAFhbXVzXnsfNoPzBBodkQErfXGt",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 2L,
                            Code = "iuqtjGFbvPtAGtuYPzRuCpGrLjXzfMkMiNFsZFDwTcduAzQeAp",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 3L,
                            Code = "UvfqHbadzNnbgUbCzACgazabSiVzasuhrDHvfKkuHxSQHybroJ",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 4L,
                            Code = "ceeMYxuUNEsktQkepPUTMPJuApFQZtndqrjbuGUohWzHYETxdf",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 5L,
                            Code = "TRHivQPvgHECuYdpyxsdMXFQMzhvEpwPYsVcbsrUXkhwoCqRNg",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 6L,
                            Code = "UhkakywsFfRVJRJVevmYujSkjbSPbrrkmxJFQyEWiUEHDiRtfa",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 7L,
                            Code = "cizvkSGfRbSvjSwwKNGBaGFBNHJfZooKzWXnDBwqWNoeJswZCz",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 8L,
                            Code = "kjtbnqKvSEoFXsrLCpSDMEKzNEPAfwbVtgnPfBxrZpJzxqZjgv",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 9L,
                            Code = "kpUjDNtdFewzWnvhmYQNUKUTLNajvRnjhTCedqHbmFCaMriyXk",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 10L,
                            Code = "hRvwLhAqauNbpFFRbMGQhRouTiVXftZrAVfaLqTTtwCAaAnTWg",
                            IsActive = true,
                            Type = "TienRitten"
                        },
                        new
                        {
                            Id = 11L,
                            Code = "rWFZDavFTAKLUpgduKgnZbJYhJmeNuJYqKacymjXtcAreTpGXt",
                            IsActive = true,
                            Type = "MaDiWoDo"
                        },
                        new
                        {
                            Id = 12L,
                            Code = "QMPwpeuboNqLsHpQMTKuNmzfYZKVWXEnpzyPpbfsAcqMNpYbVM",
                            IsActive = true,
                            Type = "MaDiWoDo"
                        },
                        new
                        {
                            Id = 13L,
                            Code = "tzSXUxyNguYRuJobmPWHTXhWjSbDDhiJhrYJMsCTnNxUiukauo",
                            IsActive = true,
                            Type = "MaDiWoDo"
                        },
                        new
                        {
                            Id = 14L,
                            Code = "ncTVbNNhUHVoWFESMprVBFGLZgUVykgYSSocopexaAYGiiVXWt",
                            IsActive = true,
                            Type = "MaDiWoDo"
                        },
                        new
                        {
                            Id = 15L,
                            Code = "jUxrtLBGXhtnzieKPUrQXjdYbAgYQNBLEtASyjYRddDNStdLta",
                            IsActive = true,
                            Type = "MaDiWoDo"
                        },
                        new
                        {
                            Id = 16L,
                            Code = "LzFXNjFxqLvhfdbHKjdnoFJsyGWFhJdahjwmPZcYkVyCUvniWL",
                            IsActive = true,
                            Type = "NationaleBios"
                        },
                        new
                        {
                            Id = 17L,
                            Code = "iUtmgyNDrhjzVNJeqAYNVJhcPqkZLiLsGJLUbGnCsadqzNmQxK",
                            IsActive = true,
                            Type = "NationaleBios"
                        },
                        new
                        {
                            Id = 18L,
                            Code = "zbTSiSeabZqRHYbiQqGMPaDkmpMdWRgJqsBjdAjWyzQMfcyiWd",
                            IsActive = true,
                            Type = "NationaleBios"
                        },
                        new
                        {
                            Id = 19L,
                            Code = "ieUiKLSUmFBJEAmwWaDpvDjejMiaJUjyQbNvYcTvmMVSvJXkvJ",
                            IsActive = true,
                            Type = "NationaleBios"
                        },
                        new
                        {
                            Id = 20L,
                            Code = "emhKrFgnnYELTheDFnsXZQwYkQmNagSzkBeEgZrdTxmmFqUDPv",
                            IsActive = true,
                            Type = "NationaleBios"
                        });
                });
