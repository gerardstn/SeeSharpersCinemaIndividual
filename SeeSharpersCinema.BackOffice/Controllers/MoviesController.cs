...
namespace SeeSharpersCinema.BackOffice.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Title,PosterUrl,Duration,Language,Technique,Description,ViewIndication,Genre,Year,Cast,Director,Country")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
